...
public:
	...
	void show_stats()
	{
		...
		std::cout << "Average wait time: " << (landing_queue->get_total_wait() / landing_queue->get_num_served());
		...
		std::cout << "Average wait time: " << (departure_queue->get_total_wait() / departure_queue->get_num_served());
		std::cout << std::endl;
